...
```sh
  cd my-folder
  git clone https://github.com/yusufobr/react-calculator.git
```
...
This project is [MIT](https://github.com/yusufobr/react-calculator/blob/development/LICENCE) licensed.
